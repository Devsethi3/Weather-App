...
const API_KEY = "9a48beb564f85d60b30c39be51f1c646";
...
const getWeatherDetails = (cityName, lat, lon) => {
  ...
  currentWeatherDiv.innerHTML =  `<div class="details">
                                    <h2>Lodaing Data...</h2>
                                    <h4>Temperature: __ __°C</h4>
                                    <h4>Wind:___ M/S</h4>
                                    <h4>Humidity: __ %</h4>
                                  </div>`;
...
const getUserCoordinates = () => {
  navigator.geolocation.getCurrentPosition(
    position => {
      ...
      .catch(() => {
        alert("An error occured while fethcing the city!");
      });
    }, 
    error => {
